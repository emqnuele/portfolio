            ...
            >
                ...
                <div className="lg:hidden flex justify-center">
                    <div className="relative w-[min(320px,85vw)] aspect-[3/4] rounded-[clamp(24px,5vw,40px)] overflow-hidden bg-zinc-900 border border-zinc-800 shadow-[0_40px_100px_rgba(4,0,15,0.55)]">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 h-1/3 bg-gradient-to-t from-black/50 to-transparent pointer-events-none z-20" />
                        <Image
                            src={ABOUT_IMAGE_SRC}
                            alt="Emanuele Faraci"
                            fill
                            className="object-cover saturate-0 brightness-[0.75] contrast-[1.2]"
                            priority
                        />
                    </div>
                </div>
